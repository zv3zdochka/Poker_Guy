...
print(f'Форма test_images: {test_images.shape}')
print(f'Форма test_labels: {test_labels.shape}')


def emnist_model(num_classes):
    model = Sequential([
...
model = emnist_model(num_classes=num_classes)
