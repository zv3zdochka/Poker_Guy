...
data_directory = r"C:\Users\batsi\PycharmProjects\Poker_Guy\Num"
...
model.fit(train_images, train_labels, batch_size=128, epochs=15, validation_data=(test_images, test_labels))

test_loss, test_accuracy = model.evaluate(test_images, test_labels)
print(f'Accuracy: {test_accuracy}')

model.save('AmountRecognizer.h5')
